# Magento 2 Wishlist Import Export Extension

[Magento 2 Wishlist Import Export](https://www.ulmod.com/wishlist-items-export-import-for-magento-2.html)  is a Magento 2 extension that allows you to easily import and export customer wishlist items including all related data.

With Magento 2 Wishlist Import and Export, you can create customer wishlists in bulk or transfer between Magento 2 sites/installations. 

<a href="https://www.ulmod.com/wishlist-items-export-import-for-magento-2.html"><img width="205" src="https://www.ulmod.com/media/wysiwyg/um-download-now1.png"></a>

## Key Features

* Export and import any number of customers wishlist via CSV file
* Ability to export wishlist for a particular customer, customer group or product
* Ability to import and export wishlist items per websites, stores, and store view
* Support sample wishlist import file right in the Import settings
* Support three wishlist import behaviors: add/update, replace and delete
* Ability to validate wishlist import file before any import
* Support wishlist export history, ability to manage all wishlist export log from the backend
* Ability to delete wishlist export logs manually or automatically

<img src="https://www.ulmod.com/media/ulmod/product_content/wishlist-export-f.png">
<img src="https://www.ulmod.com/media/ulmod/product_content/wishlist-import-f.png">
<img src="https://www.ulmod.com/media/ulmod/product_content/wishlist-exportlog-f.png">
